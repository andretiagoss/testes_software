...
{
    //Fixture para que os testes utilizem codigos reaproveitaveis com a mesma instância, pois ela mantem o seu estado.

    //CollectionDefinition para os testes da aplicação WEB
    [CollectionDefinition(nameof(IntegrationWebTestsFixtureCollection))]
    public class IntegrationWebTestsFixtureCollection : ICollectionFixture<IntegrationTestsFixture<StartupWebTests>> { }

    //CollectionDefinition para os testes da API
