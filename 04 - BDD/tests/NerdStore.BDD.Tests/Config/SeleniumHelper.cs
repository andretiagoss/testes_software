...
{
    //Classe principal que vai fazer a estrumentação do Selenium
    public class SeleniumHelper : IDisposable
    {
        public IWebDriver WebDriver;
        public readonly ConfigurationHelper Configuration;

        //Recursos para definir o tempo de espera da execução de um teste.
        ...
        {
            //Aguarda até que a condição esperada seja atendida, no caso, o elemento linkText esteja visivel, para então clicar no mesmo.
